...
in_frames[0,0] = torch.from_numpy((img0/100).float32)
in_frames[0,1] = torch.from_numpy((img1/100).float32)
in_frames[0,2] = torch.from_numpy((img2/100).float32)
out_frames[0,0] = torch.from_numpy((output/100).float32)
