...
import algorithms.rls.algorithm as algorithm


def main_program():
    '''
    This script computes RLS forecasts for the selected locations
    '''
    # Load confiuration
    ...
    logging.basicConfig(filename='admin_scripts/logs/algorithms.log',
                        ...
                        level=numeric_level)
    logging.info('Start rls/main_program.py')  # exclusive of this script
