...
class encoder_E(nn.Module):
    def __init__(self, nc=1, nf=32):
        ...
        # input is (1) x H x W
        self.c1 = dcgan_conv(nc, nf, stride=2) # nf x H/2 x W/2
        self.c2 = dcgan_conv(nf, nf, stride=1) # nf x H/2 x W/2
        self.c3 = dcgan_conv(nf, 2*nf, stride=2) # nf*2 x H/4 x W/4
...
class EncoderRNN(torch.nn.Module):
    def __init__(self, phycell, convcell, device):
        ...
        self.encoder_E = encoder_E(nc=1, nf=32) # general encoder CxHxW -> 32*2 x H/4 x W/4
