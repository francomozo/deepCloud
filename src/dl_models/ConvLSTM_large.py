...
def convlstm_encoder_params(input_seq_len, in_chan=7, image_size=128):
    size_l1 = image_size # 128
    size_l2 = image_size - (image_size // 4) # 96
    size_l3 = image_size - (image_size // 2) # 64
    size_l4 = size_l1 - size_l2 # 32
    ...
    convlstm_encoder_params = [
        ...
        [
            CLSTM_cell(shape=(size_l1, size_l1), input_channels=size_l4, filter_size=5, num_features=size_l3, seq_len=input_seq_len),
            CLSTM_cell(shape=(size_l3, size_l3), input_channels=size_l3, filter_size=5, num_features=size_l2, seq_len=input_seq_len),
            CLSTM_cell(shape=(size_l4, size_l4), input_channels=size_l2, filter_size=5, num_features=size_l1, seq_len=input_seq_len)
        ]
    ]
...
class ConvLSTM_patch(nn.Module):
    ...
    def __init__(self, input_seq_len ,seq_len, in_chan=7, image_size =128):
        super(ConvLSTM_patch, self).__init__()
        encoder_params = convlstm_encoder_params(input_seq_len, in_chan, image_size)
